...
export const metadata: Metadata = {
  ...
  description:
    "Experience authentic Irish hospitality at Oh Tommy's Pub & Grill, the Lake of the Ozarks' finest pub & grill. Join us for great food, fine drinks, live music, and unforgettable memories.",
